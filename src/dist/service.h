...
#define TSC_SERVICE_DECLARE_LOCAL(_service, \
            _name, _timeout, _auto,\
            ...
            struct tsc_service * \
                __attribute((__section__("tsc_services_section"))) \
                __attribute((__used__)) \
                _service##_address = & (_service)

#define TSC_SERVICE_DECLARE_TCP(_service, \
            _name, _timeout, _auto, _port,\
            _routine, _init_cb, _error_cb, _timeout_cb) \
            struct tsc_service _service = { \
                .sname = _name, \
